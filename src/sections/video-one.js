...
import videoImg from 'assets/videothumb.webp';
...
const VideoOne = () => {
  ...
  return (
    <Box as="section" sx={styles.video}>
      <Container>
        <Heading as="h3">
          Os potencial da AI<br />ao alcance de todos. 
        </Heading>
        <Text as="p">
          Descubra como a inteligência artificial irá transformar o mundo{' '}
          <br />
           e pode mudar realidade do seu negócio.
        </Text>
