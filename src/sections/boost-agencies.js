...
import image1 from 'assets/peopleprojects.webp';
          ...
          <Flex sx={styles.col}>
            <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                <Heading as="h3">
                Soluções de SEO para diferentes contextos de negócios.</Heading>
                <Text as="p">
                Trabalhamos com modelos de squads que atendem necessidades específicas para empresas, agências e influenciadores digitais .
                </Text>
              </Box>
              <Box as="ul" sx={styles.list}>
                ...
                <Text as="li">
                  <IoIosCheckmarkCircle />
                  Criação de Sites para SEO
                </Text>
                <Text as="li">
                  <IoIosCheckmarkCircle />
                  Migração e Reestruturação de Sites para SEO
                </Text>
                <Text as="li">
                  <IoIosCheckmarkCircle />
                  Integração de Sistemas para Data Analytics
                </Text>
              </Box>
