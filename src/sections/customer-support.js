...
import img1 from 'assets/analytica-workspace.png';
      ...
      <Container>
        <Grid sx={styles.row}>
          <Box sx={styles.col}>
            ...
            <iframe width="100%" height="650" src="https://app.pipefy.com/public/form/iGXWBGS5?embedded=true" frameborder="0"></iframe>
            </Box>
          </Box>
          <Box sx={styles.col}>
            <br /><br />
            <Image src={img1} width='100%' alt="" />
          </Box>
        </Grid>
      </Container>
    </Box>
...
const styles = {
  ...
  content: {
    pt: [0, null, null, null, '160px', '20px'],
